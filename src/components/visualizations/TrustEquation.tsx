  ...
  return (
    <div ref={containerRef} className="w-full max-w-4xl mx-auto px-4">
      ...
      <div className="text-center mb-4 md:mb-8">
        ...
        <p className="trust-detail text-sm md:text-xs text-text-secondary mt-2 max-w-md mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {components.map((comp) => (
          <div key={comp.name} className="trust-detail glass rounded-lg p-4">
            ...
            <p className="text-[15px] md:text-xs text-text-secondary mb-2 leading-relaxed">
              {comp.description}
            </p>
            <p className="text-sm md:text-xs text-text-tertiary italic">
              {comp.example}
            </p>
          </div>
        ))}
